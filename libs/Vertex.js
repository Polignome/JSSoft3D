class Vert {
    ...
    */
    ...
    set texture(a) { this._texture.x = a.x; this._texture.y = a.y; }
    set world(a) { this._world.x = a.x; this._world.y = a.y; this._world.z = a.z; }
    set screen(a) { this._screen.x = a.x; this._screen.y = a.y; this._screen.z = a.z; }
